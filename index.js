...
var PROGRAM_VERSION    = require('./package.json').version;
...
function TFCRatioConverter(file, ratio, base) {
...
//var tfc    = new TFCRatioConverter(path.resolve(process.cwd() + '/' + targetFile), Argv.get('ratio'), Argv.get('base'));
var tfc    = new TFCRatioConverter(path.resolve(process.cwd() + '/' + filePath), program.ratio, program.base);
